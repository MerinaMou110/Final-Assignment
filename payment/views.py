...
def payment(request):
    ...
    post_body = {
        ...
        'currency': "BDT",
        'tran_id': tran_id,
        'success_url': f"https://final-assignment-1.onrender.com/payment/purchase/{tran_id}/{request.user.id}/",
        'fail_url': f"https://final-assignment-1.onrender.com/order/cart/{request.user.id}/0/",
        'cancel_url': f"https://final-assignment-1.onrender.com/order/cart/{request.user.id}/0/",
        'emi_option': 0,
