...
def payment(request):
    ...
    post_body = {
        ...
        'fail_url': "https://final-assignment-1.onrender.com/order/cart/{request.user.id}/0/",
        'cancel_url': "https://final-assignment-1.onrender.com/order/cart/{request.user.id}/0/",
        'emi_option': 0,
